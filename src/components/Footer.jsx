...
function Footer() {
  return (
    <footer className='bg-[#2a491d] w-full py-12 md:py-16'>
      <div className='max-w-7xl mx-auto px-6 md:px-12'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-24'>
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <div>
              <p className='text-white font-semibold text-lg mb-4'>Stay in Touch</p>
          ...
          <div className="flex flex-row md:flex-col lg:flex-row justify-between lg:justify-start lg:gap-20 text-white">
            <div className="flex flex-col gap-4">
              <h2 className='text-xl font-bold border-b-2 border-[#50a72c] w-fit mb-2'>Navigation</h2>
              <ul className="space-y-3">
                <li><NavLink to="/" className="text-gray-200 hover:text-[#ffbd3c] transition-colors">Home</NavLink></li>
                <li><NavLink to="/about-us" className="text-gray-200 hover:text-[#ffbd3c] transition-colors">About Us</NavLink></li>
                <li><NavLink to="/products" className="text-gray-200 hover:text-[#ffbd3c] transition-colors">Products</NavLink></li>
                <li><NavLink to="/clients" className="text-gray-200 hover:text-[#ffbd3c] transition-colors">Clients</NavLink></li>
              </ul>
            </div>

            <div className="flex flex-col gap-4 mt-0 md:mt-8 lg:mt-0">
              <h2 className='text-xl font-bold border-b-2 border-[#50a72c] w-fit mb-2'>Legal</h2>
          ...
          <div className="flex flex-col items-start gap-6">
            <Link
              to="/contact"
              className="inline-block px-10 py-3 rounded-full bg-[#50a72c] text-white font-bold shadow-lg hover:shadow-[#50a72c]/20 hover:-translate-y-1 transition-all duration-300"
            >
              Contact Us
            </Link>
            ...
            <div className="space-y-5">
              <div className='flex items-start gap-3 group'>
                ...
                <a href="tel:918482950500" className='text-sm text-gray-200 group-hover:text-white transition-colors'>
                  +91 (848) 29 - 50500
                </a>
              </div>
              <div className="flex items-start gap-3 group">
                <IoIosMail className='text-[#ffbd3c] mt-0.5' size={20}/>
                <a href="mailto:info@kosshergroup.com" className='text-sm text-gray-200 group-hover:text-white transition-colors'>
